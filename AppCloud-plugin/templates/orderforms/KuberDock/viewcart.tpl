...
<div id="order-modern">
    ...
    {if $errormessage}
        ...
        </div>{elseif $promotioncode && $rawdiscount eq "0.00"}
    ...
    <form method="post" action="{$smarty.server.PHP_SELF}?a=view">
        <table class="teble custom striped" cellspacing="1" style="margin-top: -28px;">
            <thead>
                <tr align="left">
                    <th width="50%">{$LANG.orderdesc}</th>
                    <th width="50%">{$LANG.orderprice}</th>
                </tr>
            </thead>
            <tbody>
                {foreach key=num item=product from=$products}
                    <tr class="carttableproduct">
                        ...
                        <td class="textleft"><strong>{$product.pricingtext}{if $product.proratadate}<br />({$LANG.orderprorata} {$product.proratadate}){/if}</strong></td>
                    </tr>
                    {foreach key=addonnum item=addon from=$product.addons}
                        <tr class="carttableproduct">
                            <td><strong>{$LANG.orderaddon}</strong> - {$addon.name}</td>
                            <td class="textleft"><strong>{$addon.pricingtext}</strong></td>
                        </tr>
                    {/foreach}
                {/foreach}
            ...
            {foreach key=num item=domain from=$domains}
                <tr class="carttableproduct">
                    ...
                    <td class="textleft"><strong>{$domain.price}</strong></td>
                </tr>
            {/foreach}
    ...
    {if $cartitems!=0}
        ...
        <div class="signupfields{if $custtype eq "existing" && !$loggedin}{else} hidden{/if}" id="loginfrm">
            <table width="100%" cellspacing="0" cellpadding="0" class="configtable">
                <tr>
                    ...
                    <td class="fieldarea"><input type="text" name="loginemail" size="40" /></td>
                </tr>
                <tr>
                    <td class="fieldlabel">{$LANG.clientareapassword}</td>
                    <td class="fieldarea"><input type="password" name="loginpw" size="25" /></td>
                </tr>
            </table>
        </div>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" class="configtable">
                <tr>
                    ...
                    <td class="fieldarea">
                        ...
                        {else}
                            <input type="text" name="firstname" tabindex="1" style="width:80%;" value="{$clientsdetails.firstname}" />
                        {/if}
                    </td>
                    ...
                    <td class="fieldarea">
                        ...
                        {else}
                            <input type="text" name="address1" tabindex="7" style="width:80%;" value="{$clientsdetails.address1}" />
                        {/if}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="fieldarea">
                        ...
                        {else}
                            <input type="text" name="lastname" tabindex="2" style="width:80%;" value="{$clientsdetails.lastname}" />
                        {/if}
                    </td>
                    ...
                    <td class="fieldarea">
                        ...
                        {else}
                            <input type="text" name="address2" tabindex="8" style="width:80%;" value="{$clientsdetails.address2}" />
                        {/if}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="fieldarea">
                        ...
                        {else}
                            <input type="text" name="companyname" tabindex="3" style="width:80%;" value="{$clientsdetails.companyname}" />
                        {/if}
                    </td>
                    <td class="fieldlabel">{$LANG.clientareacity}</td>
                    <td class="fieldarea">
                        {if $loggedin}
                            {$clientsdetails.city}
                        {else}
                            <input type="text" name="city" tabindex="9" style="width:80%;" value="{$clientsdetails.city}" />
                        {/if}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="fieldarea">
                        ...
                        {else}
                            <input type="text" name="email" tabindex="4" style="width:90%;" value="{$clientsdetails.email}" />
                        {/if}
                    </td>
                    ...
                    <td class="fieldarea">
                        ...
                        {else}
                            <input type="text" name="state" tabindex="10" style="width:80%;" value="{$clientsdetails.state}" />
                        {/if}
                    </td>
                </tr>
                <tr>
                    {if !$loggedin}
                        <td class="fieldlabel">{$LANG.clientareapassword}</td>
                        <td class="fieldarea"><input type="password" name="password" tabindex="5" id="newpw" size="20" value="{$password}" /></td>
                    {else}
                    ...
                    <td class="fieldarea">
                        ...
                        {else}
                            <input type="text" name="postcode" tabindex="11" size="15" value="{$clientsdetails.postcode}" />
                        {/if}
                    </td>
                </tr>
                <tr>
                    {if !$loggedin}
                        <td class="fieldlabel">{$LANG.clientareaconfirmpassword}</td>
                        <td class="fieldarea">
                            <input type="password" name="password2" tabindex="6" size="20" value="{$password2}" />
                        </td>
                    {else}
                        <td class="fieldlabel"></td>
                        <td class="fieldarea"></td>
                ...
                <tr>
                    ...
                    <td class="fieldarea">
                        ...
                        {else}
                            <input type="text" name="phonenumber" tabindex="13" size="20" value="{$clientsdetails.phonenumber}" />
                        {/if}
                    </td>
                </tr>
                {if $customfields || $securityquestions}
                    {if $securityquestions && !$loggedin}
                        <tr>
                            <td class="fieldlabel">{$LANG.clientareasecurityquestion}</td>
                            <td class="fieldarea" colspan="3">
                                <select name="securityqid" tabindex="14">
                        ...
                        <tr>
                            <td class="fieldlabel">{$LANG.clientareasecurityanswer}</td>
                            <td class="fieldarea" colspan="3"><input type="password" name="securityqans" value="{$securityqans}" tabindex="15" size="30"></td>
                        </tr>
                    {/if}
                    {foreach key=num item=customfield from=$customfields}
                        <tr>
                            <td class="fieldlabel">{$customfield.name}</td>
                            <td class="fieldarea" colspan="3">{$customfield.input} {$customfield.description}</td>
                        </tr>
                    {/foreach}
                {/if}
            </table>
        ...
        <div class="checkoutcol1">
            <div class="signupfields padded">
                ...
                {else}
                    <input type="text" name="promocode" size="20" value="" />
                    <input type="submit" name="validatepromo" value="{$LANG.orderpromovalidatebutton}" />
                {/if}
            </div>
        ...
        <div class="checkoutcol2">
            <div class="signupfields padded">
                ...
                {/if}
                <div align="center">
                    <input type="submit" value="{$LANG.completeorder}"{if $cartitems==0} disabled{/if} onclick="this.value='{$LANG.pleasewait}'" class="ordernow" />
                </div>
            </form>
        {else}
            <br />
