    ...
    {foreach from=$departments item=department}
        <div class="col2half">
            <div class="contentpadded">
                <p><div class="fontsize2"><img src="{$BASE_PATH_IMG}/emails.gif" /> &nbsp;<strong><a href="{$smarty.server.PHP_SELF}?step=2&amp;deptid={$department.id}">{$department.name}</a></strong></div></p>
